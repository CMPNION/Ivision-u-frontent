...
export default function CommitteeProfilePage(): React.JSX.Element {
    ...
    return (
      <section className="space-y-4">
        ...
        <p className="text-sm text-slate-500">
          Нет активной сессии. Пожалуйста, войдите, чтобы увидеть профиль.
        </p>
      </section>
    );
  }
    ...
    <section className="space-y-6">
      <header className="space-y-2">
        ...
        <h1 className="text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">
          Профиль члена приёмной комиссии
        </h1>
        <p className="text-sm text-slate-500 sm:text-base">
          Данные пользователя. Основа для будущего подключения API.
        </p>
      </header>
      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="rounded-lg border border-dashed border-slate-200 bg-slate-50 px-4 py-3 text-xs text-slate-500">
            Это демо-профиль. После подключения API сюда можно добавить фото,
            отдел, телефон, историю действий или тонкую настройку прав.
          </div>
        </CardContent>
      </Card>
    </section>
